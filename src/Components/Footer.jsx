        ...
        <div class="md:flex md:justify-between">
          ...
          <div>
                  ...
                  <ul class="text-gray-500  font-medium">
                      ...
                      <li  className="mb-4">
                          <NavLink to={'/store'}  class="hover:underline">Store</NavLink>
                      </li>
                      <li  className="mb-4">
                          <NavLink to={'/dispose'}  class="hover:underline">Dispose</NavLink>
                      </li>
                  </ul>
              </div>
              ...
              <div>
                  ...
                  <ul class="text-gray-500  font-medium">
                      <li class="mb-4">
                          <p className="hover:underline">+91 9174802507</p>
                      </li>
                      <li className="mb-4">
                          <p class="hover:underline">ecogeek2024@gmail.com</p>
                      </li>
                      <li  className="mb-4">
                          <p class="hover:underline">New delhi(India)</p>
                      </li>
                  </ul>
              </div>
              ...
              <div>
                  ...
                  <ul class="text-gray-500  font-medium">
                      <li class="mb-4">
                          <p  class="hover:underline">Pick-Up by employees</p>
                      </li>
                      <li>
                          <p class="hover:underline">Self Submisson</p>
                      </li>
                  </ul>
              </div>
              <div>
