  ...
  return (
    <div className='w-full h-full p-5 mx-auto ' >
        ...
        <div className='flex flex-col items-center w-full h-auto mt-2'>
            ...
            <button  class={`inline-flex items-center justify-center w-full px-8 py-2 text-sm font-semibold text-white bg-green-500 rounded-md hover:bg-green-400 sm:w-auto sm:mb-0 ${currState == NavData.length && 'hidden' } `}  onClick={NextHandler} data-primary="green-400" data-rounded="rounded-2xl" data-primary-reset="{}">
                Proceed
