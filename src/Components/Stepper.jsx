            ...
            <div className='flex justify-evenly'>
                {
                    NavData.map((obj,i)=>(
                        <div className='z-10 flex flex-col items-center'>
                            <div className={`flex items-center justify-center w-10 h-10 font-semibold   rounded-full ${i+1 <= currState ? 'bg-blue-600 text-white':'bg-white text-black'} `}>
                                {i+1}
                                </div>
                            <p className='sm:text-lg text-xs '>{obj.title}</p>
                        </div>
                    ))
                }
            </div>
